# 🤖 lalah-chatbot - A Helpful Companion for Afghan Students
...
## 🌐 Features
- Supports multiple languages: Dari, Pashto, and English.
- Provides educational content tailored for Afghan students.
- Utilizes advanced technology from OpenAI and LangChain.
...
You can customize the chatbot to suit your preferences:
- **Language Settings**: Choose your preferred language from the settings menu.
- **Response Type**: Adjust how detailed the chatbot's answers are. Select "Brief" for quick answers or "Detailed" for thorough explanations.
